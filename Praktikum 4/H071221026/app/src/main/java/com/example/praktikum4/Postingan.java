...
public class Postingan implements Parcelable {
    ...
    public Postingan(String username, String name, String desc, int fotoProfile, int fotoPostingan) {
    ...
    public Postingan(String username, String souma, String konten, int soumaP, Uri selectedImageUri) {
        this.username = username;
        this.name = souma;
        this.desc = konten;
        this.fotoProfile = soumaP;
