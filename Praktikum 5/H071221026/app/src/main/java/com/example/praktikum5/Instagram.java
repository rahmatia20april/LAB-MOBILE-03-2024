...
public class Instagram implements Parcelable {
    ...
    public Instagram(String name_fail, String username_fail, String konten, int profile_fail, Uri selectedImageUri) {
        this.username = name_fail;
        this.name = username_fail;
        this.desc = konten;
        this.fotoProfile = profile_fail;
